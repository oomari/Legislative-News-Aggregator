    ...
    <nav>
      <div className="shadow-sm flex p-6 mb-8 items-center justify-between">
        ...
        <div className="flex gap-4 pr-10 text-white">
          <button className="text-sm text-[#6da8f0] hover:text-blue-600 transition-all ease-in-out font-bold border-transparent opacity-60 bg-gray-700 rounded-md p-4">
            Request a Demo
          </button>
